...
public class Collectable extends Sprite {
    ...
    void createCollectableBody(){
        ...
        bodyDef.position.set((getX() + getWidth() / 2 - 45) / GameInfo.PPM,(getY() + getWidth() / 2 + 30) /GameInfo.PPM );
    ...
    public void setCollectiblePosition(float x, float y){
        setPosition(x, y);
        createCollectableBody();

    }

    public void updateCollecteable(){
        setPosition(body.getPosition().x * GameInfo.PPM, body.getPosition().y * GameInfo.PPM - 30);
    }
