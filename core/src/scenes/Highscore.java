...
public class Highscore implements Screen{
    ...
    private OrthographicCamera mainCamera;//Displays everything on the camera
    private Viewport gameViewport;//Holds the camera
    ...
    public void render(float delta) {
        Gdx.gl.glClearColor(0, 0, 0, 1);//Clearing the screen
